...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form:form modelAttribute="donation" method="post" action="/donation/save">
            ...
            <div data-step="1" class="active">
                ...
                <c:forEach items="${categories}" var="category">
                    <div class="form-group form-group--checkbox">
                        <label>
<%--                            <form:checkbox path="categories" value="${category.id}" name="${category.name}" />--%>
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="institutionEl">
                    <div class="form-group form-group--checkbox">
                        <label>
...
<%--                            <input type="radio" name="organization" value="old">--%>
                            ...
                            <span class="description">
                              ...
                              <div class="subtitle">
                                Cel i misja: ${institutionEl.description}
                              </div>
                            </span>
                        </label>
                    </div>
                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="summary--text">Dla: <span id="institutionFinal"></span> </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li id="pickUpDateFinal"></li>
                                <li id="pickUpTimeFinal"></li>
                                <li id="pickUpCommentFinal"></li>
                            </ul>
                        </div>
                    </div>
                </div>
